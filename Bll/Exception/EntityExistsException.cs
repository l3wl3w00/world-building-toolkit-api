...
public class EntityAlreadyExistsException : System.Exception
{
    ...
    public EntityAlreadyExistsException(Type entityType, string uniqueValueName) :
    ...
    public EntityAlreadyExistsException(Type entityType) :
        base($"A(n) {entityType.Name} entity already exists that has some unique constraint on it that does not let you ad a new one")
    {
